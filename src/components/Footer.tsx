          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2.5">
              <li className="flex items-start space-x-2.5 text-sm text-gray-400">
                ...
                <span>100 Premium Avenue, Fifth Floor, New York, NY 10001</span>
              </li>
              <li className="flex items-center space-x-2.5 text-sm text-gray-400">
                <Phone className="w-4 h-4 text-gold flex-shrink-0" />
                <a href="tel:+18005555893" className="hover:text-gold transition-colors">+1 (800) 555-LUXE</a>
              </li>
              <li className="flex items-center space-x-2.5 text-sm text-gray-400">
                <Mail className="w-4 h-4 text-gold flex-shrink-0" />
                <a href="mailto:concierge@luxestay.com" className="hover:text-gold transition-colors">concierge@luxestay.com</a>
              </li>
            </ul>
          </div>
